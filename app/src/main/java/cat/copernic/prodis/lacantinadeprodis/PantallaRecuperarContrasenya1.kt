 ...
 * Use the [PantallaRecuperarContrasenya1.newInstance] factory method to
...
class PantallaRecuperarContrasenya1 : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PantallaRecuperarContrasenya1.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PantallaRecuperarContrasenya1().apply {
